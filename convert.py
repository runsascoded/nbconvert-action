...
def main():
  ...
  parser.add_argument('-d', '--pip_deps', help='Comma-separated list of pip dependencies to install')
  parser.add_argument('-e', '--email', help='user.email for Git commit')
  ...
  parser.add_argument('-m', '--map', action='append', help='Re-map notebooks paths to different outputs')
  parser.add_argument('-n', '--name', help='user.name for Git commit')
  ...
  parser.add_argument('--readme', help='Convert this notebook to README.md (short-hand for `-m <path>:README.md`')
  parser.add_argument('-r', '--remote', help='Git remote to push changes to; defaults to the only git remote, where applicable')
  ...
  parser.add_argument('-U', '--no-untracked', action='store_true', help='Skip adding untracked files (e.g. new .md paths generated by this action) to Git (and pushing them to the repo)')
